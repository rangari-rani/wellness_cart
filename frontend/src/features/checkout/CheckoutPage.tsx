          ...
          {activeStep === steps.length ? (
            <>
              ...
              <Typography variant="subtitle1">
                Your order number is #{orderNumber}. We will send you an update when your order has shipped.
              </Typography>
              <Button
                component={Link}
                to="/store"
            ...
            <>
              ...
              <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
                {activeStep !== 0 && (
                  <Button onClick={handleBack} color='success' variant="outlined" sx={{ mt: 3, ml: 1 }}>
                    Back
                  </Button>
                )}
                <Button
